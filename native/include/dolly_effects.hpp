...
namespace dolly {
struct EffectSpec { const char* name; unsigned type; double minimum, maximum; bool discrete; unsigned components=1; };
...
struct EffectTrack {
 unsigned id=0; bool restore_override=false; unsigned component=0;
