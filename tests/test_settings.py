...
class SettingsTests(unittest.TestCase):
    ...
    def test_roundtrip_custom_keyboard_binding_and_only_binding_persists(self):
        ...
        self.assertEqual(set(raw), {"version", "capture_binding"})
    ...
    def test_replace_failure_preserves_old_file_and_cleans_temp(self):
        ...
        replacement = AppSettings(CaptureBinding(key="F8", ctrl=False, alt=False, shift=False))
