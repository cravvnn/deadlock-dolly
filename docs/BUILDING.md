...
## Update an existing GitHub repository to 0.3.10

1. Extract `Deadlock_Dolly_0.3.10_GitHub_Update.zip` locally.
...
6. Download **Deadlock-Dolly-Windows-x64** from the successful run's artifacts.
   Extract it, then extract `Deadlock_Dolly_0.3.10-alpha_Windows_x64.zip` inside it.
...
- `Deadlock_Dolly_0.3.10-alpha_Windows_x64.zip`
- `Deadlock_Dolly_0.3.10-alpha_Source.zip`
- `SHA256SUMS.txt`
