...
## Update an existing GitHub repository to 0.4.7-alpha

Use the **complete** `Deadlock_Dolly_0.4.7_Source.zip` supplied for this update
...
6. Open the successful run, scroll to **Artifacts**, and download
   **Deadlock-Dolly-Windows-x64**. Extract the artifact, then extract the
   `Deadlock_Dolly_0.4.7-alpha_Windows_x64.zip` inside it.
...
1. Open your repository's **Releases**, then create a new release for the
   commit that produced the tested build. Use a tag such as `v0.4.7-alpha`.
...
- `Deadlock_Dolly_0.4.7-alpha_Windows_x64.zip`
- `Deadlock_Dolly_0.4.7-alpha_Source.zip`
- `SHA256SUMS.txt`
